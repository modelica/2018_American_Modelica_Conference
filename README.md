...
4. Modeling Integrated Community Energy and Harvesting Systems from Databases using OpenModelica (43)
...
5. Modeling and Control of the IRIS IPWR in a HighRenewables Grid Using TRANSFORM (44)
...
2. Analysing the stability of an Islanded hydro-electric power system (4)
...
6. A Method to Import an FMU to a Hardware Description Language (8)
...
7. The Deployable Structures Library (9)
...
8. Modelica-Based Dynamic Modeling of a Solar Powered Ground Source Heat Pump System: A Preliminary Case Study (12)
...
9. Control Description Language (13)
...
10. Hybridisation and splitting of a crank angle resolved internal combustion engine model using a mean value intake for real-time performance (14)
...
11. Modeling of PMU-Based Islanded Operation Controls for Power Distribution Networks using Modelica and OpenIPSL (15)
...
15. A Modelica Library for Thin-Layer Drying of Agricultural Products (20)
...
16. Modelica language – a promising tool for publishing and sharing biomedical models (21)
...
17. A Safe Regression Test Selection Technique for Modelica (22)
...
20. Dirt Late Model Race Car Simulations with Dymola / Modelica (27)
...
21. The OpenModelica Integrated Modeling, Simulation, and Optimization Environment (29)
...
22. Functional Mock-up Interface: An empirical survey identifies research challenges and current barriers (30)
...
26. Developing a Framework for Modeling Underwater Vehicles in Modelica (34)
